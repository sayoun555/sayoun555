...
> [!NOTE]
> **백엔드 개발자**를 목표로 공부하고 있습니다.
> 기능을 동작시키는 데서 멈추지 않고, **왜 그렇게 동작하는지** 한 겹 더 들어가 안정적인 서버와 데이터 설계를 고민합니다.

- 🔭 **Java · Spring** 기반 백엔드 개발에 집중하고 있어요
- 🌱 **42 Gyeongsan**에서 동료 학습 · 프로젝트 기반으로 CS 기초를 다지는 중
...
![MySQL](https://img.shields.io/badge/MySQL-4479A1?style=flat-square&logo=mysql&logoColor=white) ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) ![Supabase](https://img.shields.io/badge/Supabase-3FCF8E?style=flat-square&logo=supabase&logoColor=white)

**DevOps**

![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white) ![Jenkins](https://img.shields.io/badge/Jenkins-D24939?style=flat-square&logo=jenkins&logoColor=white)

## Work Experience

외주로 의뢰받아 설계·구현부터 배포까지 직접 진행한 프로젝트입니다.
